    ...
    <div className="min-h-screen bg-slate-50">
      <div className="container-wide py-12">
        ...
        >
          ...
          <p className="text-center text-slate-600 mb-6">Click on any blue state to view details</p>

          <div className="max-w-4xl mx-auto mb-6">
            <LeafletMap selectedState={selectedState} onStateSelect={setSelectedState} />
          </div>

          <p className="text-center text-sm text-slate-500">
            🔵 Blue = Our Coverage States | ⚫ Gray = Other Indian States
          </p>
        </motion.div>
